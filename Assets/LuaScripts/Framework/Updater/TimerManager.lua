...
local function Startup(self)
	self:Dispose()
	local obj = TimerManager:GetInstance()
	...
	self.__coupdate_handle = CoUpdateBeat:RegisterListener(CoUpdateHandle, obj)
	self.__colateupdate_handle = CoLateUpdateBeat:RegisterListener(CoLateUpdateHandle, obj)
	self.__cofixedupdate_handle = CoFixedUpdateBeat:RegisterListener(CoFixedUpdateHandle, obj)
end
