...
function CS.UnityEngine.Events.PersistentCallGroup:RegisterEventPersistentListener(index, targetObj, methodName)
end

---@param index : CS.System.Int32
---@param targetObj : CS.UnityEngine.Object
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterVoidPersistentListener(index, targetObj, methodName)
end
...
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterObjectPersistentListener(index, targetObj, argument, methodName)
end
...
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterIntPersistentListener(index, targetObj, argument, methodName)
end
...
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterFloatPersistentListener(index, targetObj, argument, methodName)
end
...
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterStringPersistentListener(index, targetObj, argument, methodName)
end
...
---@param methodName : CS.System.String
function CS.UnityEngine.Events.PersistentCallGroup:RegisterBoolPersistentListener(index, targetObj, argument, methodName)
end
