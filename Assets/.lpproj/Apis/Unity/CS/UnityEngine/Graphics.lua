...
---@param bounds : CS.UnityEngine.Bounds
---@param bufferWithArgs : CS.UnityEngine.ComputeBuffer
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs)
end
...
---@param bufferWithArgs : CS.UnityEngine.ComputeBuffer
---@param argsOffset : CS.System.Int32
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset)
end
...
---@param argsOffset : CS.System.Int32
---@param properties : CS.UnityEngine.MaterialPropertyBlock
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset, properties)
end
...
---@param properties : CS.UnityEngine.MaterialPropertyBlock
---@param castShadows : CS.UnityEngine.Rendering.ShadowCastingMode
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset, properties, castShadows)
end
...
---@param castShadows : CS.UnityEngine.Rendering.ShadowCastingMode
---@param receiveShadows : CS.System.Boolean
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset, properties, castShadows, receiveShadows)
end
...
---@param receiveShadows : CS.System.Boolean
---@param layer : CS.System.Int32
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset, properties, castShadows, receiveShadows, layer)
end
...
---@param layer : CS.System.Int32
---@param camera : CS.UnityEngine.Camera
function CS.UnityEngine.Graphics.DrawMeshInstancedIndirect(mesh, submeshIndex, material, bounds, bufferWithArgs, argsOffset, properties, castShadows, receiveShadows, layer, camera)
end
