...
---@param L : CS.System.IntPtr
---@param val : CS.UnityEngine.TouchPhase
function CS.XLua.ObjectTranslator:PushUnityEngineTouchPhase(L, val)
end
...
---@param index : CS.System.Int32
---@param val : CS.UnityEngine.TouchPhase
function CS.XLua.ObjectTranslator:UpdateUnityEngineTouchPhase(L, index, val)
end
