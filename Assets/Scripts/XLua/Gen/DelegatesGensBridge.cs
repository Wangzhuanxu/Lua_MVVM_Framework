...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public bool __Gen_Delegate_Imp4(int p0, UnityEngine.Vector3 p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(UnityEngine.Playables.PlayableDirector p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(string p0, int p1, float p2, string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string[] __Gen_Delegate_Imp15(object p0, object p1, bool p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public byte[] __Gen_Delegate_Imp19(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp20(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Func<int, UnityEngine.Vector3, bool>))
			{
			    return new System.Func<int, UnityEngine.Vector3, bool>(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new System.Action<UnityEngine.Playables.PlayableDirector>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<string, int, float, string>))
			{
			    return new System.Action<string, int, float, string>(__Gen_Delegate_Imp7);
			}
